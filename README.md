...
This project is jointly supported by [Digimarc](https://www.digimarc.com/) and [Zebra](https://www.zebra.com/).
...
```html
<script src="https://cdn.jsdelivr.net/npm/epcis2.js@2.7.1/dist/epcis2.browser.js"></script>
```
