...
describe('Hashing algorithm utils', () => {
  ...
  describe('removeWhiteSpaceAtTheBeginningOrEndOfString function', () => {
    it('Should return the parameter', () => {
      ...
      expect(removeWhiteSpaceAtTheBeginningOrEndOfString('2.187968')).to.be.equal('2.187968');
      expect(removeWhiteSpaceAtTheBeginningOrEndOfString(String('foo'))).to.be.equal('foo');
      expect(removeWhiteSpaceAtTheBeginningOrEndOfString(2)).to.be.equal(2);
      expect(removeWhiteSpaceAtTheBeginningOrEndOfString({}).toString()).to.be.equal({}.toString());
    });
    ...
    it('Should remove useless spaces', () => {
      ...
      expect(removeWhiteSpaceAtTheBeginningOrEndOfString(' 2.187968   ')).to.be.equal('2.187968');
      expect(
        removeWhiteSpaceAtTheBeginningOrEndOfString(String('        foo        ')),
      ).to.be.equal('foo');
    });
  });
  ...
  describe('formatTheDateToFollowTheAlgorithmRules function', () => {
    it('Should return the parameter', () => {
      ...
      expect(formatTheDate('2.187968')).to.be.equal('2.187968');
      expect(formatTheDate(String('foo'))).to.be.equal('foo');
      expect(formatTheDate(2)).to.be.equal(2);
      expect(formatTheDate({}).toString()).to.be.equal({}.toString());
    });

    it('Should not add a Z at the end', () => {
      expect(addATrailingZ('2005-07-11T11:30:47.0Z')).to.be.equal('2005-07-11T11:30:47.0Z');
      expect(addATrailingZ('2005-04-03T20:33:31.116000-06:00')).to.be.equal(
        '2005-04-03T20:33:31.116000-06:00',
      );
    });

    it('Should add a Z at the end', () => {
      expect(addATrailingZ('2005-07-11T11:30:47.0')).to.be.equal('2005-07-11T11:30:47.0Z');
    });

    it('Should not add millisecond precision', () => {
      expect(formatTheDate('2005-07-11T11:30:47.000Z')).to.be.equal('2005-07-11T11:30:47.000Z');
    });

    it('Should add millisecond precision', () => {
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47Z')).to.be.equal(
        '2005-07-11T11:30:47.000Z',
      );
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47-06:00')).to.be.equal(
        '2005-07-11T11:30:47.000-06:00',
      );
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47.0Z')).to.be.equal(
        '2005-07-11T11:30:47.000Z',
      );
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47.0-06:00')).to.be.equal(
        '2005-07-11T11:30:47.000-06:00',
      );
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47.00Z')).to.be.equal(
        '2005-07-11T11:30:47.000Z',
      );
      expect(addMillisecondPrecisionToDate('2005-07-11T11:30:47.00-06:00')).to.be.equal(
        '2005-07-11T11:30:47.000-06:00',
      );
    });

    it('Should remove millisecond precision', () => {
      expect(addMillisecondPrecisionToDate('2005-04-03T20:33:31.116000-06:00')).to.be.equal(
        '2005-04-03T20:33:31.116-06:00',
      );
    });

    it('Should return valid UTC dates without offsets', () => {
      expect(formatTheDate('2005-04-03T20:33:31.116000-06:00')).to.be.equal(
        '2005-04-04T02:33:31.116Z',
      );
  ...
  describe('removeTimeZonePropertyIfItIsNeeded function', () => {
    it('Should return the parameter', () => {
      expect(removeTimeZoneProperty('2005-04-03T20:33:31.116Z')).to.be.equal(
        '2005-04-03T20:33:31.116Z',
      );
    });

    it('Should remove the timezone', () => {
      expect(removeTimeZoneProperty('2019-10-21T11:00:30.000+01:00')).to.be.equal(
        '2019-10-21T10:00:30.000Z',
      );
      expect(removeTimeZoneProperty('2005-04-03T20:33:31.116-06:00')).to.be.equal(
        '2005-04-04T02:33:31.116Z',
      );
    });
  });
  ...
  describe('readAllTheContextProvidedInTheObject function', () => {
    it('Should return an empty object', () => {
      ...
      expect(getEventContexts({ foo: 'foo' }).toString()).to.be.equal({}.toString());
    });
