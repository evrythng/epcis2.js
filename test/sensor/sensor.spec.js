...
describe('unit tests for sensor relative Objects', () => {
  describe('SensorMetadata.js', () => {
    it('should create a valid SensorMetadata object from setters', async () => {
      ...
      expect(sensorMetadata.getDataProcessingMethod()).to.be.equal(JSONSensorMetadata.dataProcessingMethod)
  ...
  describe('SensorReportElement.js', () => {
    it('should create a valid SensorReportElement object from setters', async () => {
      ...
      expect(sensorReport.getDataProcessingMethod()).to.be.equal(JSONSensorReportElement.dataProcessingMethod)
      ...
      expect(sensorReport.getChemicalSubstance()).to.be.equal(JSONSensorReportElement.chemicalSubstance)
  ...
  describe('SensorElement.js', () => {
    ...
    it('should create a valid SensorElement object from JSON', async () => {
      ...
      expect(sensorElement.getSensorMetadata().time).to.be.equal(JSONSensorElement.sensorMetadata.time)
      expect(sensorElement.getSensorMetadata().deviceID).to.be.equal(JSONSensorElement.sensorMetadata.deviceID)
      expect(sensorElement.getSensorMetadata().rawData).to.be.equal(JSONSensorElement.sensorMetadata.rawData)
      expect(sensorElement.getSensorReport()[0].type).to.be.equal(JSONSensorElement.sensorReport[0].type)
      expect(sensorElement.getSensorReport()[1].type).to.be.equal(JSONSensorElement.sensorReport[1].type)
      expect(sensorElement.getSensorReport()[2].type).to.be.equal(JSONSensorElement.sensorReport[2].type)
      expect(sensorElement.getSensorReport()[0].value).to.be.equal(JSONSensorElement.sensorReport[0].value)
      expect(sensorElement.getSensorReport()[0].uom).to.be.equal(JSONSensorElement.sensorReport[0].uom)
      expect(sensorElement.getSensorReport()[1].chemicalSubstance).to.be.equal(JSONSensorElement.sensorReport[1].chemicalSubstance)
      expect(sensorElement.getSensorReport()[1].value).to.be.equal(JSONSensorElement.sensorReport[1].value)
      expect(sensorElement.getSensorReport()[1].uom).to.be.equal(JSONSensorElement.sensorReport[1].uom)
      expect(sensorElement.getSensorReport()[2].microorganism).to.be.equal(JSONSensorElement.sensorReport[2].microorganism)
      expect(sensorElement.getSensorReport()[2].value).to.be.equal(JSONSensorElement.sensorReport[2].value)
      expect(sensorElement.getSensorReport()[2].uom).to.be.equal(JSONSensorElement.sensorReport[2].uom)
    })
    it('should add and remove custom fields', async () => {
